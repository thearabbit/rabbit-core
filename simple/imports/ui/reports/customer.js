...
// Declare template
let formTmpl = Template.Simple_customerReport,
    genTmpl = Template.Simple_customerReportGen;
...
let hooksObject = {
    ...
    onSuccess: function (formType, result) {
        ...
        let path = FlowRouter.path("simple.customerReportGen", params, queryParams);
...
AutoForm.addHooks('Simple_customerReport', hooksObject);
