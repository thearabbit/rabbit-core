...
// Declare template
let indexTmpl = Template.Simple_order,
    actionTmpl = Template.Simple_orderAction,
    newTmpl = Template.Simple_orderNew,
    editTmpl = Template.Simple_orderEdit,
...
indexTmpl.events({
    ...
    'click .js-invoice' (event, instance) {
        ...
        let path = FlowRouter.path("simple.orderReportGen", params, queryParams);
...
editTmpl.onCreated(function () {
    this.autorun(()=> {
        this.subscribe('simple.order', {_id: this.data._id});
    });
});
